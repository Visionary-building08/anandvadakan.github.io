...
const LINKS = [
  ...
  },
  {
    ...
    href: 'https://www.linkedin.com/in/anandvadakan',
    icon: (
  ...
  {
    label: 'Notion',
    value: 'Case Studies Portfolio',
    href: 'https://anand-casestudy-concept.notion.site/Case-Studies-Portfolio-3890bae0d832804580edc00d8d1eaec6',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
